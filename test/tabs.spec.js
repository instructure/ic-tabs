...
test('not selected element attributes', function() {
  expect(4);
  var component = buildComponent(this);
  var tab = Ember.View.views['tab2'].$();
  var panel = Ember.View.views['panel2'].$();
...
// somehow got these passing on some version of ember somewhere,
// but when testing version support I can't get any of these
// interactions past the autoruns anymore (didn't have to do anything
// fancy before, though)
